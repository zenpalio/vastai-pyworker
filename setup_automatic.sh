function setup_gsutils() {
    ...
    DEBIAN_FRONTEND=noninteractive sudo apt install apt-transport-https ca-certificates gnupg curl -y
    ...
    DEBIAN_FRONTEND=noninteractive sudo apt install google-cloud-cli -y
